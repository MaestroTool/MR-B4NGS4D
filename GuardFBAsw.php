...
pilih:
    system($bersih);
    echo"
$red Pencipta  : Maestro
$red Type      : Profil Guard Facebook 
$red Facebook  : www.facebook.com/maestro10001
$lightred NICK      : MRB4NGS4D
$blue Version   : 2.0 
$darkgray Date      : $date 
";
    echo " 
...
";
    ...
    echo " 
";
    input("$green Apa kamu ingin menggunakan Tool kami?  $green [y/n]");
...
");
        ...
        echo "$red ATTENTION :$blue Untuk menghindari SESI atau CheckPoint silahkan Log-in terlebih dahulu melalui (Browser,Opera,Google,UC dan..)
";
        echo "$brown Kata Sandi di sembunyikan...
";
        echo "
";
        input("$red Email/Nomer HP/Username");
...
";
        ...
        echo ("
");
        die("$red [!]Kata sandi / username salah!
");
        echo "
";
    }
...
";
          sleep(1.5);
        echo "$yellow Semoga Hari mu Menyenangkan BozQue :v
";
